...
namespace Deploy.LaunchPad.Util
{
    ...
    /// Implements the <see cref="System.IEquatable{Deploy.LaunchPad.Util.LaunchPadToken}" />
    /// </summary>
    /// <seealso cref="System.IEquatable{Deploy.LaunchPad.Util.LaunchPadToken}" />
    [Serializable]
    public partial class LaunchPadToken : IEquatable<LaunchPadToken>
    {
        ...
        [MaxLength(9, ErrorMessageResourceName = "Validation_Token_Prefix_9CharsOrLess", ErrorMessageResourceType = typeof(Deploy_LaunchPad_Util_Resources))]
        [Required]
        ...
        [MaxLength(20, ErrorMessageResourceName = "Validation_Token_Name_20CharsOrLess", ErrorMessageResourceType = typeof(Deploy_LaunchPad_Util_Resources))]
        [Required]
        [DataObjectField(false)]
        [XmlAttribute]
        ...
        {
            Guard.Against<ArgumentException>(string.IsNullOrEmpty(tokenString), Deploy_LaunchPad_Util_Resources.Guard_LaunchPadToken_ArgumentException_Empty);
            Guard.Against<ArgumentException>(!tokenString.StartsWith("{{"), Deploy_LaunchPad_Util_Resources.Guard_LaunchPadToken_ArgumentException_WrongStartsWith);
            Guard.Against<ArgumentException>(!tokenString.EndsWith("}}"), Deploy_LaunchPad_Util_Resources.Guard_LaunchPadToken_ArgumentException_WrongEndWith);
            Guard.Against<ArgumentException>(!tokenString.Contains("|"), Deploy_LaunchPad_Util_Resources.Guard_LaunchPadToken_ArgumentException_NoDelimiter);
