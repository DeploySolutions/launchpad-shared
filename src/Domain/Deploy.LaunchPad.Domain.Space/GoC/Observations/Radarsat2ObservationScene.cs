...
namespace Deploy.LaunchPad.Domain.Space.GoC
{
    ...
    /// Implements the <see cref="Deploy.LaunchPad.Domain.Space.GoC.RadarsatObservationSceneCommonMetadata" />
    /// Implements the <see cref="Deploy.LaunchPad.Domain.Space.GoC.IRadarsatObservationScene" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Domain.Space.GoC.RadarsatObservationSceneCommonMetadata" />
    /// <seealso cref="Deploy.LaunchPad.Domain.Space.GoC.IRadarsatObservationScene" />
    [Serializable()]
