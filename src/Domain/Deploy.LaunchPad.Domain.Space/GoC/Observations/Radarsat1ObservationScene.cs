...
namespace Deploy.LaunchPad.Domain.Space.GoC
{
        ...
        IRadarsatObservationScene
    {
        ...
        /// Implements the <see cref="Deploy.LaunchPad.Domain.Space.Core.IObservationFiles{System.Guid}" />
        /// </summary>
        /// <seealso cref="Deploy.LaunchPad.Domain.Space.Core.IObservationFiles{System.Guid}" />
