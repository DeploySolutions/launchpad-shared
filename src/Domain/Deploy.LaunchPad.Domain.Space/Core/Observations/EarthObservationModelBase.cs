...
namespace Deploy.LaunchPad.Domain.Space.Core
{
    ...
    /// Implements the <see cref="Deploy.LaunchPad.Domain.Space.Core.IEarthObservationScene" />
    /// </summary>
    /// <seealso cref="LaunchPadModelBase" />
    /// <seealso cref="Deploy.LaunchPad.Domain.Space.Core.IEarthObservationScene" />
