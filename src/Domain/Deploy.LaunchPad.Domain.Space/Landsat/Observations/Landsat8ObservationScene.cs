...
namespace Deploy.LaunchPad.Domain.Space.Landsat
{
    ...
    /// Implements the <see cref="Deploy.LaunchPad.Domain.Space.Landsat.ILandsatObservationScene" />
    /// </summary>
    ...
    /// <seealso cref="Deploy.LaunchPad.Domain.Space.Landsat.ILandsatObservationScene" />
