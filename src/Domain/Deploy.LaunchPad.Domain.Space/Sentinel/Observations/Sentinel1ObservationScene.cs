...
namespace Deploy.LaunchPad.Domain.Space.Sentinel
{
    ...
    /// Implements the <see cref="Deploy.LaunchPad.Domain.Space.Sentinel.ISentinel1ObservationScene" />
    /// </summary>
    /// <seealso cref="EarthObservationModelBase" />
    /// <seealso cref="Deploy.LaunchPad.Domain.Space.Sentinel.ISentinel1ObservationScene" />
