// ***********************************************************************
// Assembly         : Deploy.LaunchPad.Domain.Organizations
...
using Deploy.LaunchPad.Domain.Organizations;
using Schema.NET;
using System;

namespace Deploy.LaunchPad.Domain.Organizations.Canada
{
    /// <summary>
    /// Class CanadaSpaceAgency.
    /// Implements the <see cref="Deploy.LaunchPad.Domain.Organizations.GovernmentOrganizationBase{System.Guid}" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Domain.Organizations.GovernmentOrganizationBase{System.Guid}" />
    public partial class CanadianSpaceAgency : GovernmentOrganizationBase<Guid>
    {
        ...
        /// </summary>
        public CanadianSpaceAgency() : base()
        {
