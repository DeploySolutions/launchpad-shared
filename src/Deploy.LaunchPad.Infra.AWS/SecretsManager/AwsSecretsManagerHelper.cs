...
namespace Deploy.LaunchPad.Infra.AWS.SecretsManager
{
    /// <summary>
    /// Class AwsSecretsManagerHelper.
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.SecretsManager.AmazonSecretsManagerConfig}" />
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.SecretsManager.IAwsSecretsManagerHelper" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.SecretsManager.AmazonSecretsManagerConfig}" />
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.SecretsManager.IAwsSecretsManagerHelper" />
