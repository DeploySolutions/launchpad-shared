...
namespace Deploy.LaunchPad.Infra.AWS.SQS
{
    /// <summary>
    /// Class AwsSQSHelper.
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.SQS.AmazonSQSConfig}" />
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.SQS.IAwsSqsHelper" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.SQS.AmazonSQSConfig}" />
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.SQS.IAwsSqsHelper" />
