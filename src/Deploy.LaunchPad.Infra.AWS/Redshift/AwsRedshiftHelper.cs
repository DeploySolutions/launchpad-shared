...
namespace Deploy.LaunchPad.Infra.AWS.Redshift
{
    /// <summary>
    /// Class AwsRedshiftHelper.
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.Redshift.AmazonRedshiftConfig}" />
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.Redshift.IAwsRedshiftHelper" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.Redshift.AmazonRedshiftConfig}" />
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.Redshift.IAwsRedshiftHelper" />
