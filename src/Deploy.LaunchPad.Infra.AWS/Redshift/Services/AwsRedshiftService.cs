...
namespace Deploy.LaunchPad.Infra.AWS.Redshift.Services
{
    /// <summary>
    /// Class AwsRedshiftService.
    /// Implements the <see cref="LaunchPadAbpSystemIntegrationServiceBase" />
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.Redshift.Services.IAwsRedshiftService" />
    /// </summary>
    /// <seealso cref="LaunchPadAbpSystemIntegrationServiceBase" />
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.Redshift.Services.IAwsRedshiftService" />
