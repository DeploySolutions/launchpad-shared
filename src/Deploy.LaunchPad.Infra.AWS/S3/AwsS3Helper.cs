...
namespace Deploy.LaunchPad.Infra.AWS.S3
{
    /// <summary>
    /// Class AwsS3Helper.
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.S3.AmazonS3Config}" />
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.S3.IAwsS3Helper" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.S3.AmazonS3Config}" />
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.S3.IAwsS3Helper" />
