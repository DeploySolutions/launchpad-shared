...
namespace Deploy.LaunchPad.Infra.AWS.ApiGateway
{
    /// <summary>
    /// Class AwsApiGatewayHelper.
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.APIGateway.AmazonAPIGatewayConfig}" />
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.IAwsApiGatewayHelper" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.APIGateway.AmazonAPIGatewayConfig}" />
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.IAwsApiGatewayHelper" />
