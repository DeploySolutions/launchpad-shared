...
namespace Deploy.LaunchPad.Core.Abp.Application.Dto
{
    ...
    /// Implements the <see cref="Deploy.LaunchPad.Core.Abp.Application.Dto.GetFullOutputDtoBase{TIdType}" />
    /// </summary>
    /// <typeparam name="TIdType">The type of the t identifier type.</typeparam>
    /// <seealso cref="Deploy.LaunchPad.Core.Abp.Application.Dto.GetFullOutputDtoBase{TIdType}" />
