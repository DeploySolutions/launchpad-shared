...
https://github.com/DeploySolutions/launchpad-shared/tree/main/src/Deploy.LaunchPad.Core.Abp

This repository stores classes and files related to AspNetBoilerPlate version of the Core Project, for use in the LaunchPad framework which is part of the Software Factory technology and approach by Deploy Software Solutions, inc. ("Deploy Solutions").
