...
namespace Deploy.LaunchPad.FileGeneration.Structure.SourceControl
{
    ...
    /// Implements the <see cref="Deploy.LaunchPad.FileGeneration.Structure.SourceControl.ReleaseAssetBase" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.FileGeneration.Structure.SourceControl.ReleaseAssetBase" />
    [Serializable]
