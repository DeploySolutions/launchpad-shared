...
namespace Deploy.LaunchPad.Geospatial.H3.Extensions;

/// <summary>
/// Extends the <see cref="H3Index"/> class with support for Directed Edge
/// functionality.
/// </summary>
public static partial class H3DirectedEdgeExtensions {
    /// <summary>
    ...
    public static double EdgeLengthKilometers(this H3Index edge) {
        return edge.EdgeLengthRadians() * H3Constants.EARTH_RADIUS_KM;
    }
