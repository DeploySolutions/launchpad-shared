...
public sealed partial class CoordIJK {
    ...
    public CoordIJK UpAperture7CounterClockwise() {
        unchecked {
            ...
            I = (int)H3Utils.CRound((3 * i - j) / 7.0);
            J = (int)H3Utils.CRound((i + 2 * j) / 7.0);
            K = 0;
    ...
    public CoordIJK UpAperture7Clockwise() {
        unchecked {
            ...
            I = (int)H3Utils.CRound((2 * i + j) / 7.0);
            J = (int)H3Utils.CRound((3 * j - i) / 7.0);
            K = 0;
    ...
    public static CoordIJK CubeRound(double i, double j, double k, CoordIJK? toUpdate = default) {
        ...
        coord.I = (int)H3Utils.CRound(i);
        coord.J = (int)H3Utils.CRound(j);
        coord.K = (int)H3Utils.CRound(k);
