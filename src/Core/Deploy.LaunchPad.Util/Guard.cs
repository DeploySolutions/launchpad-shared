...
namespace Deploy.LaunchPad.Util
{
    ...
    public static partial class Guard
    {
        ...
        public static T AgainstNull<T>(T value, [InvokerParameterName][NotNull] string parameterName)
        {
            if (value == null)
            {
        ...
        [ContractAnnotation("value:null => halt")]
        public static string AgainstNullOrEmpty(string value, [InvokerParameterName][NotNull] string parameterName)
        {
        ...
        [ContractAnnotation("value:null => halt")]
        public static string AgainstNullOrWhiteSpace(string value, [InvokerParameterName][NotNull] string parameterName)
        {
        ...
        [ContractAnnotation("value:null => halt")]
        public static ICollection<T> AgainstNullOrEmpty<T>(ICollection<T> value, [InvokerParameterName][NotNull] string parameterName)
        {
            if (value.IsNullOrEmpty())
            {
                throw new ArgumentNullException(parameterName + " can not be null or empty!", parameterName);
