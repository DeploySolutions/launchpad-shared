// ***********************************************************************
// Assembly         : Deploy.LaunchPad.Code.Python
...
namespace Deploy.LaunchPad.Code.Python
{
    ...
    /// Extends the <see cref="System.IComparable{Deploy.LaunchPad.Code.Python.PythonInstallationReference}" />
    /// Extends the <see cref="System.IEquatable{Deploy.LaunchPad.Code.Python.PythonInstallationReference}" />
    /// </summary>
    /// <seealso cref="ILaunchPadObject" />
    /// <seealso cref="ISerializable" />
    /// <seealso cref="System.IComparable{Deploy.LaunchPad.Code.Python.PythonInstallationReference}" />
    /// <seealso cref="System.IEquatable{Deploy.LaunchPad.Code.Python.PythonInstallationReference}" />
