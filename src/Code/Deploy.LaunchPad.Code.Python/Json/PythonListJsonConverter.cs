...
using System.Linq;
using Deploy.LaunchPad.Code.Python.Json;

namespace Deploy.LaunchPad.Code.Python
{
    /// <summary>
    /// Class PythonListJsonConverter.
    /// Implements the <see cref="Newtonsoft.Json.JsonConverter{System.Collections.Generic.List{Deploy.LaunchPad.Code.Python.Json.PythonInstallationJson}}" />
    /// </summary>
    /// <seealso cref="Newtonsoft.Json.JsonConverter{System.Collections.Generic.List{Deploy.LaunchPad.Code.Python.Json.PythonInstallationJson}}" />
