...
namespace Deploy.LaunchPad.Code.Python
{
    ...
    /// Extends the <see cref="System.IComparable{Deploy.LaunchPad.Code.Python.PythonVersion}" />
    /// Extends the <see cref="System.IEquatable{Deploy.LaunchPad.Code.Python.PythonVersion}" />
    /// </summary>
    /// <seealso cref="ISerializable" />
    /// <seealso cref="System.IComparable{Deploy.LaunchPad.Code.Python.PythonVersion}" />
    /// <seealso cref="System.IEquatable{Deploy.LaunchPad.Code.Python.PythonVersion}" />
