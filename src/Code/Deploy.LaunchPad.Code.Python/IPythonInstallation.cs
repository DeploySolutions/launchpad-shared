...
namespace Deploy.LaunchPad.Code.Python
{
    ...
    /// Extends the <see cref="System.IComparable{Deploy.LaunchPad.Code.Python.PythonInstallation}" />
    /// Extends the <see cref="System.IEquatable{Deploy.LaunchPad.Code.Python.PythonInstallation}" />
    /// </summary>
    /// <seealso cref="ILaunchPadObject" />
    /// <seealso cref="ISerializable" />
    /// <seealso cref="System.IComparable{Deploy.LaunchPad.Code.Python.PythonInstallation}" />
    /// <seealso cref="System.IEquatable{Deploy.LaunchPad.Code.Python.PythonInstallation}" />
