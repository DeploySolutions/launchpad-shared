...
namespace Deploy.LaunchPad.Code.Python
{
    ...
    /// Implements the <see cref="Deploy.LaunchPad.Code.Python.IPythonInstallationReference" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Code.Python.IPythonInstallationReference" />
    [Serializable()]
