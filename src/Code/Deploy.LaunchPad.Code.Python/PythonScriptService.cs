...
namespace Deploy.LaunchPad.Code.Python
{
    ...
    /// Implements the <see cref="Deploy.LaunchPad.Code.Python.IPythonScriptService" />
    /// </summary>
    /// <seealso cref="ILaunchPadSystemIntegrationService" />
    /// <seealso cref="Deploy.LaunchPad.Code.Python.IPythonScriptService" />
    public partial class PythonScriptService : LaunchPadServiceBase, ILaunchPadSystemIntegrationService, IPythonScriptService
    {
        ...
        public PythonScriptService(ILogger logger, Uri pythonInstallationFilePath, string scriptFileName) : base()
        {
