...
namespace Deploy.LaunchPad.Code.Python
{
    ...
    /// Implements the <see cref="System.IEquatable{Deploy.LaunchPad.Code.Python.PythonReleaseRegistry}" />
    /// </summary>
    /// <seealso cref="System.IEquatable{Deploy.LaunchPad.Code.Python.PythonReleaseRegistry}" />
    [Serializable]
