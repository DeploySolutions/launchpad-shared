...
namespace Deploy.LaunchPad.Infra.AWS.ElasticFileSystem
{
    ...
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.ElasticFileSystem.IAwsElasticFileSystemHelper" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.ElasticFileSystem.AmazonElasticFileSystemConfig}" />
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.ElasticFileSystem.IAwsElasticFileSystemHelper" />
