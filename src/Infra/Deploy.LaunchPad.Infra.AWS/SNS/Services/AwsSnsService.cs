...
using Deploy.LaunchPad.Infra.AWS.SNS.Services;
...
namespace Deploy.LaunchPad.Infra.AWS.SNS.Services
{
    public partial class AwsSnsService : SystemIntegrationServiceBase, IAwsSnsService
    {
        ...
        public AwsSnsService(ILogger logger, Amazon.RegionEndpoint region) : base(logger)
        {
