...
namespace Deploy.LaunchPad.Infra.AWS.S3
{
    ...
    /// Extends the <see cref="Deploy.LaunchPad.Infra.AWS.IAwsHelper{Amazon.S3.AmazonS3Config}" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.IAwsHelper{Amazon.S3.AmazonS3Config}" />
