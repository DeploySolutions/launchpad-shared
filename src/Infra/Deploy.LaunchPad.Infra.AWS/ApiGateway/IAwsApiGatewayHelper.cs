...
namespace Deploy.LaunchPad.Infra.AWS.ApiGateway
{
    ...
    /// Extends the <see cref="Deploy.LaunchPad.Infra.AWS.IAwsHelper{Amazon.APIGateway.AmazonAPIGatewayConfig}" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.IAwsHelper{Amazon.APIGateway.AmazonAPIGatewayConfig}" />
