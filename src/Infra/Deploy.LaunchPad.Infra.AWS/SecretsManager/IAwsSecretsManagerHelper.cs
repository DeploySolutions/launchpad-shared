...
namespace Deploy.LaunchPad.Infra.AWS.SecretsManager
{
    ...
    /// Extends the <see cref="Deploy.LaunchPad.Infra.AWS.IAwsHelper{Amazon.SecretsManager.AmazonSecretsManagerConfig}" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.IAwsHelper{Amazon.SecretsManager.AmazonSecretsManagerConfig}" />
