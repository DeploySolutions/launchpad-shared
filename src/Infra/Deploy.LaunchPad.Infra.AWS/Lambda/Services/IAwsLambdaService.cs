...
// ***********************************************************************
// <copyright file="IAwsLambdaService.cs" company="Deploy Software Solutions, inc.">
...
namespace Deploy.LaunchPad.Infra.AWS.Lambda.Services
{
    /// <summary>
    /// Interface IAwsLambdaService
    /// Extends the <see cref="ILaunchPadSystemIntegrationService" />
    /// </summary>
    /// <seealso cref="ILaunchPadSystemIntegrationService" />
    public partial interface IAwsLambdaService : ILaunchPadSystemIntegrationService
    {
        /// <summary>
