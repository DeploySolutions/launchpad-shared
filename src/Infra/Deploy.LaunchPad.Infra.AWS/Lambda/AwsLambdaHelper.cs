...
namespace Deploy.LaunchPad.Infra.AWS.Lambda
{
    /// <summary>
    /// Class AwsLambdaHelper.
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.Lambda.AmazonLambdaConfig}" />
    /// Implements the <see cref="Deploy.LaunchPad.Infra.AWS.Lambda.IAwsLambdaHelper" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.AwsHelperBase{Amazon.Lambda.AmazonLambdaConfig}" />
    /// <seealso cref="Deploy.LaunchPad.Infra.AWS.Lambda.IAwsLambdaHelper" />
