    ...
    public partial class MimeTypeMap : IMimeTypeMap, ITransientDependency
    {
        ...
        protected virtual Dictionary<string, string> BuildMappings()
        {
            var mappings = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                //
                {FileExtension.astro.ToString(), "text/astro"},
                {FileExtension.audiate.ToString(), "application/vnd.techsmith.audiate"},
                {FileExtension.env.ToString(), "text/plain"},
                {FileExtension.targz.ToString(), "application/x-compressed-tar"},
                {FileExtension.toon.ToString(), "application/x-toon"},
                {FileExtension.tscproj.ToString(), "application/vnd.techsmith.camtasia.project"},
                {FileExtension.yaml.ToString(), "application/x-yaml"},
                {FileExtension.zarr.ToString(), "application/x-zarr"},
                {FileExtension.avi.ToString(), "video/x-msvideo"},
                {FileExtension.bmp.ToString(), "image/bmp"},
                {FileExtension.css.ToString(), "text/css"},
                {FileExtension.csv.ToString(), "text/csv"},
                {FileExtension.doc.ToString(), "application/msword"},
                {FileExtension.docx.ToString(), "application/vnd.openxmlformats-officedocument.wordprocessingml.document"},
                {FileExtension.gif.ToString(), "image/gif"},
                {FileExtension.gz.ToString(), "application/x-gzip"},
                {FileExtension.html.ToString(), "text/html"},
                {FileExtension.ini.ToString(), "text/plain"},
                {FileExtension.jpeg.ToString(), "image/jpeg"},
                {FileExtension.jpg.ToString(), "image/jpeg"},
                {FileExtension.js.ToString(), "application/javascript"},
                {FileExtension.json.ToString(), "application/json"},
                {FileExtension.md.ToString(), "text/markdown"},
                {FileExtension.mdx.ToString(), "text/mdx"},
                {FileExtension.mov.ToString(), "video/quicktime"},
                {FileExtension.mp3.ToString(), "audio/mpeg"},
                {FileExtension.mp4.ToString(), "video/mp4"},
                {FileExtension.odp.ToString(), "application/vnd.oasis.opendocument.presentation"},
                {FileExtension.ods.ToString(), "application/vnd.oasis.opendocument.spreadsheet"},
                {FileExtension.odt.ToString(), "application/vnd.oasis.opendocument.text"},
                {FileExtension.pdf.ToString(), "application/pdf"},
                {FileExtension.png.ToString(), "image/png"},
                {FileExtension.ppt.ToString(), "application/vnd.ms-powerpoint"},
                {FileExtension.pptx.ToString(), "application/vnd.openxmlformats-officedocument.presentationml.presentation"},
                {FileExtension.ps1.ToString(), "application/x-powershell"},
                {FileExtension.py.ToString(), "text/x-python"},
                {FileExtension.rar.ToString(), "application/x-rar-compressed"},
                {FileExtension.resx.ToString(), "application/xml"},
                {FileExtension.sql.ToString(), "application/sql"},
                {FileExtension.svg.ToString(), "image/svg+xml"},
                {FileExtension.tar.ToString(), "application/x-tar"},
                {FileExtension.tiff.ToString(), "image/tiff"},
                {FileExtension.wav.ToString(), "audio/wav"},
                {FileExtension.webp.ToString(), "image/webp"},
                {FileExtension.wmv.ToString(), "video/x-ms-wmv"},
                {FileExtension.xls.ToString(), "application/vnd.ms-excel"},
                {FileExtension.xlsx.ToString(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"},
                {FileExtension.xml.ToString(), "text/xml"},
                {FileExtension.zip.ToString(), "application/zip"},

                // Retain all other entries not in FileExtensions enum
                {".323", "text/h323"},
                {".3g2", "video/3gpp2"},
                {".3gp", "video/3gpp"},
                {".3gp2", "video/3gpp2"},
                ...
                {".tscproj", "application/vnd.techsmith.camtasia.project"},
                ...
                {"application/vnd.techsmith.audiate",".audiate"},
                {"application/vnd.techsmith.camtasia.project",".tscproj"},
