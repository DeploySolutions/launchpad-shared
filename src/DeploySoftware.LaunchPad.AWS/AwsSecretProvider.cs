...
namespace DeploySoftware.LaunchPad.AWS
{
    public partial class AwsSecretProvider : SecretProviderBase, ISecretProvider
    {
        ...
        public async override Task<string> GetJsonFromSecretVaultAsync(ISecretVault secretVault, string caller)
        {
            ...
            catch (DecryptionFailureException e)
            {
                ...
                Logger.Error(string.Format(
                    DeploySoftware_LaunchPad_AWS_Resources.Logger_Error_GetJsonFromSecret_ExceptionThrown, secretVault.Id, e.Message));
                throw;
            }
            catch (InternalServiceErrorException e)
            {
                // An error occurred on the server side.
                Logger.Error(string.Format(DeploySoftware_LaunchPad_AWS_Resources.Logger_Error_GetJsonFromSecret_ExceptionThrown, secretVault.Id, e.Message));
                throw;
            }
        ...
        {
            Logger.Info(string.Format(DeploySoftware_LaunchPad_AWS_Resources.Logger_Info_GetCredentialsFromSecret_Getting, secretVault.Id));
            ...
            Logger.Info(string.Format(DeploySoftware_LaunchPad_AWS_Resources.Logger_Info_GetCredentialsFromSecret_Got, secretVault.Id));
        ...
        {
            Logger.Info(string.Format(DeploySoftware_LaunchPad_AWS_Resources.Logger_Info_UpdateJsonForSecret_Updating, value, key, secretVault.Id));
            ...
            Logger.Info(string.Format(DeploySoftware_LaunchPad_AWS_Resources.Logger_Info_UpdateJsonForSecret_Updated, value, key, secretVault.Id));
        ...
        public async override Task<HttpStatusCode> UpdateFieldsInSecretVaultAsync(ISecretVault secretVault, IDictionary<string, string> fieldsToInsertOrUpdate, string caller)
        {
            ...
            if (!string.IsNullOrEmpty(sbUpdatedSecretJson))
            {
                ...
                catch (EncryptionFailureException e)
                {
                    ...
                    Logger.Error(string.Format(DeploySoftware_LaunchPad_AWS_Resources.Logger_Error_WriteValueToSecret_Exception, secretVault.Id, e.Message));
                    throw;
                }
                catch (InternalServiceErrorException e)
                {
