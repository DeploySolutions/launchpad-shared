...
https://github.com/DeploySolutions/launchpad-shared/tree/main/src/Deploy.LaunchPad.Core

This repository stores classes and files that are a core part of the LaunchPad framework which is part of the Software Factory technology and approach by Deploy Software Solutions, inc. ("Deploy Solutions").
