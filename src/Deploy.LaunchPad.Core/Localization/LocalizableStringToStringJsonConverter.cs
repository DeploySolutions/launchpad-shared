...
namespace Deploy.LaunchPad.Core.Localization
{
    ...
    public partial class LocalizableStringToStringJsonConverter : JsonConverter
    {
        ...
        public LocalizableStringToStringJsonConverter(ILocalizationContext localizationContext) 
        {
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            writer.WriteValue(localizableString.Localize(_localizationContext));
        }
