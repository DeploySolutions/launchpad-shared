...
namespace Deploy.LaunchPad.Core.Licenses
{
    ...
    public partial class OpenGovernmentCanadaLicense : License
    {
        ...
        public OpenGovernmentCanadaLicense() : base(
           new ElementName(Deploy_LaunchPad_Core_Resources.Text_OpenGovernmentCanadaLicense_LicenseName),
           new Uri(Deploy_LaunchPad_Core_Resources.Text_OpenGovernmentCanadaLicense_LicenseTerms),
           new ElementDescription(Deploy_LaunchPad_Core_Resources
