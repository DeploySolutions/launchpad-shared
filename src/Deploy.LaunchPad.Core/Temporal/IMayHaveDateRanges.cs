...
namespace Deploy.LaunchPad.Core.Temporal
{
    ...
    /// </summary>
    public partial interface IMayHaveDateRanges : ILaunchPadObject
    {

        /// <summary>
        /// Gets or sets the effective date, if any
        ...
        public DateTimeOffset? EffectiveDateTimeInUtc { get; set; }

        /// <summary>
        /// Gets or sets the start date, if any
        /// https://github.com/radiantearth/stac-spec/blob/master/commons/common-metadata.md#date-and-time-range
        /// </summary>
        /// <value>Start date / time of the object, in UTC.</value>
        public DateTimeOffset? StartDateTimeInUtc { get; set; }


        /// <summary>
        /// Gets or sets the end date, if any
        /// https://github.com/radiantearth/stac-spec/blob/master/commons/common-metadata.md#date-and-time-range
        /// </summary>
        /// <value>End date / time of the object, in UTC.</value>
        public DateTimeOffset? EndDateTimeInUtc { get; set; }
    }
}