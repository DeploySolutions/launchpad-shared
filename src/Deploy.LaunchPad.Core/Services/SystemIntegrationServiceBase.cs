...
namespace Deploy.LaunchPad.Core.Services
{
    ...
    /// Implements the <see cref="Deploy.LaunchPad.Core.Services.ILaunchPadSystemIntegrationService" />
    /// </summary>
    /// <seealso cref="Deploy.LaunchPad.Core.Services.ILaunchPadSystemIntegrationService" />
    [Serializable()]
