...
// using the json schema found here: https://geojson.org/schema/Polygon.json
// 
...
namespace Deploy.LaunchPad.Core.GeoJson
{
    ...
    {
        public static string ToJson(this Polygon self) => JsonConvert.SerializeObject(self, Deploy.LaunchPad.Core.GeoJson.PolygonConverter.Settings);
    }
