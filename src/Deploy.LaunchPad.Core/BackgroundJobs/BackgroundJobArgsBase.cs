...
namespace Deploy.LaunchPad.Core.BackgroundJobs
{
    ...
    /// Implements the <see cref="IBackgroundJobArgs" />
    /// </summary>
    /// <seealso cref="IBackgroundJobArgs" />
    [Serializable]
    public abstract partial class BackgroundJobArgsBase : IBackgroundJobArgs
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BackgroundJobArgsBase"/> class.
        /// </summary>
        protected BackgroundJobArgsBase()
        {
        ...
        protected BackgroundJobArgsBase(string id)
        {
            Id = id;
            Name = Id;
        }
        ...
        protected BackgroundJobArgsBase(string id, string name, string chron)
        {
            Id = id;
            Name = name;
            Chron = chron;
