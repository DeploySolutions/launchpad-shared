...
namespace Deploy.LaunchPad.Geospatial.Tests
{
    ...
    public partial class GeographicLocationTests
    {
        ...
        public void Should_Have_Valid_Elevation_Number_When_Instantiated()
        {
            ...
            Assert.Contains(Deploy_LaunchPad_Geospatial_Resources.Guard_GeographicLocation_Set_Elevation, ex.Message);
        }
        ...
        public void Should_Have_Valid_Latitude_Number_When_Instantiated()
        {
            ...
            Assert.Contains(Deploy_LaunchPad_Geospatial_Resources.Guard_GeographicLocation_Validate_Point, ex.Message);
        }
        ...
        public void Should_Not_Allow_Latitude_Less_Than_Minus_90()
        {
            ...
            Assert.Contains(Deploy_LaunchPad_Geospatial_Resources.Guard_GeographicLocation_Set_Latitude_Not_LessThan_Minus_90, ex.Message);
        }
        ...
        public void Should_Not_Allow_Latitude_Greater_Than_90()
        {
            ...
            Assert.Contains(Deploy_LaunchPad_Geospatial_Resources.Guard_GeographicLocation_Set_Latitude_Not_GreaterThan_90, ex.Message);
        }
        ...
        public void Should_Not_Allow_Longitude_LessThan_Minus180()
        {
            ...
            Assert.Contains(Deploy_LaunchPad_Geospatial_Resources.Guard_GeographicLocation_Set_Longitude_Not_LessThan_Minus180, ex.Message);
        }
        ...
        public void Should_Not_Allow_Longitude_MoreThan_180()
        {
            ...
            Assert.Contains(Deploy_LaunchPad_Geospatial_Resources.Guard_GeographicLocation_Set_Longitude_Not_GreaterThan_180, ex.Message);
        }
