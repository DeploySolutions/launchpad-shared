...
namespace DeploySoftware.LaunchPad.Images.Tests
{
    ...
    public class ImageManagerTests : IClassFixture<ImageManagerTestsFixture>
    {
        ...
        {
            MagickImage image = new MagickImage(_fixture.SUT.GetThumbnailFromImage(_fixture.Logo, ImageManager.ThumbnailSize.Small));
        ...
        {
            MagickImage image = new MagickImage(_fixture.SUT.GetThumbnailFromImage(_fixture.Logo, ImageManager.ThumbnailSize.Medium));
        ...
        {
            MagickImage image = new MagickImage(_fixture.SUT.GetThumbnailFromImage(_fixture.Logo, ImageManager.ThumbnailSize.Large));
