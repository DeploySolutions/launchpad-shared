...
namespace DeploySoftware.LaunchPad.Shared.Tests
{
    ...
    {
        public readonly TifWorldFileParser<Guid> TfwParser;

        public readonly FileKey TfwFileKey;
        ...
        public TfwWorldFileTestsFixture()
        {
            ...
            TfwFileKey = new FileKey(fileName);
            TfwParser = new TifWorldFileParser<Guid>();
            TfwFile = TfwParser.GetTifWorldFileFromMetadataFile(TfwFileKey);
        }
